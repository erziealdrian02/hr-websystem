                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-slate-700/50 rounded-lg border border-gray-100 dark:border-gray-600">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <label class="toggle-switch">
                                <input type="checkbox" name="is_active" id="toggle-status" onchange="toggleStatus()"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="hidden" name="head_employee_id" id="head_employee_id" value="{{ old('head_employee_id', $division->head_employee_id ?? '') }}">
                            <input type="text" id="head-search"
                                placeholder="Cari karyawan untuk ditetapkan..."
                                oninput="searchEmployee(this.value)"
                                class="w-full pl-9 pr-4 py-2.5 text-sm rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-slate-700 text-gray-900 dark:text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition outline-none">
                        </div>
